...
This file is a verbatim copy of `Mathlib/Combinatorics/SimpleGraph/Extremal/KovariSosTuran.lean`
as it stands in the open Mathlib pull request
[#25841](https://github.com/leanprover-community/mathlib4/pull/25841), authored by Mitchell Horner
(continuing the work of [#20240](https://github.com/leanprover-community/mathlib4/pull/20240)),
at commit `8f4ec0b3adc694d08665af3e3126487338a43434`.  The only changes are the removal of the
`module` / `public import` declarations, which the Mathlib revision this project pins does not yet
accept for downstream files.

It is vendored here only because the pull request has not been merged yet; once it lands, this file
should be deleted and `Mathlib.Combinatorics.SimpleGraph.Extremal.KovariSosTuran` imported instead.
Copyright and authorship remain with Mitchell Horner, and the file stays under the Apache 2.0
license of Mathlib.
-/
